...
func doTestCaseInsensitive(t *testing.T, typ, config string) {
	...
	assert.Equal(t, true, Get("rFD"))
	assert.Equal(t, 1, assist.ToInt(Get("abcd")))
	assert.Equal(t, 1, assist.ToInt(Get("Abcd")))
	assert.Equal(t, 2, assist.ToInt(Get("ef.gh")))
	assert.Equal(t, 3, assist.ToInt(Get("ef.ijk")))
	assert.Equal(t, 4, assist.ToInt(Get("ef.lm.no")))
	assert.Equal(t, 5, assist.ToInt(Get("ef.lm.p.q")))
